...
function setup() {
  ...
  createCanvas(1403,800);//the size of background
...
//Discription
let s = 'This is Pepa, she looks like a normal bird. But, if you cross her the wrong way she will pierce you with her eyes !';

fill(126);
text(s, 914, 390, 400, 400); // Text wraps within text box
textSize(30);
//the sun
